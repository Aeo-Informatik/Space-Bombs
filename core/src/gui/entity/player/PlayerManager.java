...
public class PlayerManager 
{
    ...
    public void update()
    {
        ...
        if(mainPlayer != null)
        {
            if(mainPlayer.getLife() <= 0)
            {
                ...
                spectator = new Spectator(mainPlayer.getPosition(), new ThinGridCoordinates(0, 0), mainPlayer.getPlayerId(), camera, map, enemies, entityManager);
     ...
     */
    public int getPlayerIdInCell(MapCellCoordinates localCellPos)
    {
            ...
            {                
                try
                {
                    ...
                    MapCellCoordinates enemyCell = new MapCellCoordinates(enemy.getPlaceItemLocation());
            ...
            try
            {
                ...
                MapCellCoordinates mainCell = new MapCellCoordinates(mainPlayer.getPlaceItemLocation());
