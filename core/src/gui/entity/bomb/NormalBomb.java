...
public class NormalBomb extends Bomb
{
    ...
    public NormalBomb(ThinGridCoordinates pos, int playerId, int range, MapLoader map, EntityManager entityManager) 
    {
        super(pos, playerId, range, Constants.NORMALBOMBEXPLOSIONTIME, Constants.NORMALBOMBEXPLOSIONDURATION, Constants.NORMALBOMBDELAYEXPLODEAFTERHITBYBOMB, map, entityManager);
    }
