...
public class RemoteBomb extends Bomb{
    ...
    public RemoteBomb(ThinGridCoordinates pos, ThinGridCoordinates direction, int range, int playerId, MapLoader map, EntityManager entityManager) 
    {
        super(pos, direction, range, 0.1f, Constants.NORMALBOMBEXPLOSIONDURATION, Constants.NORMALBOMBDELAYEXPLODEAFTERHITBYBOMB, playerId, map, entityManager);
    }
...
//                fuseSound.stop();
            ...
            if(activated == true || super.hasBombTouchedDeadlyTile == true){
            //Add passed time to timer
