...
public class Barrel extends CubicBomb {
    ...
    public Barrel(ThinGridCoordinates pos, ThinGridCoordinates direction, int cubicRange, int playerId, MapLoader map, EntityManager entityManager) 
    {
        ...
        super(pos, direction, cubicRange +1, 1, Constants.BARRELEXPLOSIONDURATION, Constants.BARRELDELAYEXPLODEAFTERHITBYBOMB, playerId, map, entityManager);
        super.setBombAnimation(TextureManager.barrelAnim);
