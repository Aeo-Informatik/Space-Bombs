...
public class HomingBomb extends Bomb
{
    ...
    public HomingBomb(ThinGridCoordinates pos, int playerId, int range, MapLoader map, EntityManager entityManager) {
        super(pos, playerId, range, Constants.NORMALBOMBEXPLOSIONDURATION, Constants.NORMALBOMBEXPLOSIONDURATION, Constants.NORMALBOMBDELAYEXPLODEAFTERHITBYBOMB, map, entityManager);
    }
