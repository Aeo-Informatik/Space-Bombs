...
public class TextureManager 
{
    ...
    public static void load() 
    {
        ...
        speedup = loadTexture("item/speed_upgrade.png");
        speedUp = new TextureRegion(speedup,0,0,32,32);
        
        bombup = loadTexture("item/bomb_upgrade.png");
        bombUp = new TextureRegion(bombup,0,0,32,32);
        
        rangeup = loadTexture("item/range_upgrade.png");
        rangeUp = new TextureRegion(rangeup,0,0,32,32);
        
        coin = loadTexture("item/coin.png");
